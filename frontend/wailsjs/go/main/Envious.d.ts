...
export function KVGetMultiple(arg1:Array<string>):Promise<Array<string>>;

export function KVIsSet(arg1:string):Promise<boolean>;

export function KVSet(arg1:string,arg2:string):Promise<void>;

export function KVSetMultiple(arg1:Array<kv.KV>):Promise<void>;
